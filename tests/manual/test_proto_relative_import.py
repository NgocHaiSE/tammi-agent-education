...
pytest.skip("Old generic test suppressed; use agent-specific test file: test_proto_relative_import_medical.py", allow_module_level=True)


def test_agents_pb2_grpc_uses_relative_import():
    proto_dir = os.path.join(os.path.dirname(__file__), os.pardir, 'proto')
